...
- (void)viewDidLoad {
    ...
    QPHomeViewController *circle = [[QPHomeViewController alloc] init];
    [self setupChildVc:circle title:@"首页" image:@"首页-未选择" selectedImage:@"首页-选择"];
 
    
    QPsViewController *mess = [[QPsViewController alloc] init];
    [self setupChildVc:mess title:@"旗袍师" image:@"旗袍师-未选择" selectedImage:@"旗袍师-选择"];
 
    
    QPOrderViewController *order = [[QPOrderViewController alloc] init];
    [self setupChildVc:order title:@"订单" image:@"订单-未选择" selectedImage:@"订单-选择"];

    QPMeViewController *share = [[QPMeViewController alloc] init];
