...
typedef NS_ENUM(NSInteger, SWNetworkStatus){
    SWNetworkStatusUnknown = -1,//未知状态
    SWNetworkStatusNotReachable = 0,//无网状态
    SWNetworkStatusReachableViaWWAN = 1,//手机网络
    SWNetworkStatusReachableViaWiFi = 2,//Wifi网络
};
...
@interface AppNetworkTool : NSObject

@property (nonatomic, assign) SWNetworkStatus netStatus;
...
/**网络状态*/
+ (void)checkingNetworkResult:(void(^)(SWNetworkStatus status))result;
