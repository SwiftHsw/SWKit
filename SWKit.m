...
@import AVFoundation;
@interface ATPopOverRootViewController : UIViewController
@property (nonatomic) BOOL statusBarHidden;
@property (nonatomic) UIStatusBarStyle statusBarStyle;
@end


@implementation ATPopOverRootViewController
...
+ (UIWindow *)popOverWindow {
    ...
    dispatch_once(&onceToken, ^{
        ...
        popOverWindow.rootViewController = [[ATPopOverRootViewController alloc] initWithNibName:nil bundle:nil];
    });
...
+ (void)addViewToPopOverWindow:(UIView *)view {
    ATPopOverRootViewController *vc = (ATPopOverRootViewController *)[self popOverWindow].rootViewController;
